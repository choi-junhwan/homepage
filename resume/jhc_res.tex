...
- Developing and deploying W+ membership benefit recommendation system using a large-scale similarity search. W+ member churn analysis (model prediction and model explanation).\\
- Walmart online purchase basket analysis based on association rules and Knowledge Graphs with PySpark pipeline for PoC for the Contextual intelligence project.\\
...
{\bf Languages:} Python, C/C++, Fortran, SQL, Matlab/Octave, R, Scala\\
{\bf Python Data Science Softwares:} Scipy, Pandas, Matplotlib, StatsModels, Scikit-Learn, Keras/Tensorflow, Pytorch, EconML, LLM/LangChain \\
